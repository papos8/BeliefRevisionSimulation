...
'''
# Randomly created test for Anchoring Bias Conditioning with resources
file = open(
    "Randomly_Created_Tests/AnchoringBiasConditioningWithResources.txt", "w")
file.write(
    "Compare unbiased conditioning and anchoring bias conditioning.\nIn these tests we also compare when the two methods idenitfy the actual world to see if anchoring bias conditioning is faster than unbiased conditionin.\n")
...
'''
# Randomly created test for Anchoring Bias Lexicographic Revision with resources
file = open(
    "Randomly_Created_Tests/AnchoringBiasLexRevisionWithResources.txt", "w")
file.write(
    "Compare unbiased lexicographic and anchoring bias lexicographic revision.\nIn these tests we also compare when the two methods idenitfy the actual world to see if anchoring bias lexicographic revision is faster than unbiased lexicographic revision.\n")
file.write("These tests also include resources of the agents in order to see whether anchoring bias is good method as an heuristic.\n")
file.write("""First states and observables are created and then the plausibility orders of the agents.\nThe two agents have the same plausibility orders, but different stubbornness degrees. \n\n""")
file.write(str(numberOfTests) +
           " randomly created tests will be generated and the success percentage will be displayed in the end.\n")
